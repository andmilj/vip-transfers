...
class Ripple extends React.Component {
  ...
  render() {
    ...
    let className = this.props.loading ? 'Ripple-loading' : 'Ripple-normal';
    if (this.state.active) className += ` Ripple-active`;
    if (this.state.restarting) className += ` Ripple-restarting`;
    if (this.props.className) className += ` ${this.props.className}`;

    return (
      <span data-react-toolbox='ripple' className={'Ripple-wrapper'}>
